                ...
                <img className="w-3/4 mb-8 lg:mb-12" src={logo} alt="Ubomi Logo" />
                  <div>
                    <div className="md:hidden lg:block">
                      <h1 className="lg:block text-center font-semibold lg:text-left text-4xl lg:text-6xl leading-snug mb-8 lg:mb-12 text-white">EVENTS & 
                    ...
                    <p className="lg:mr-12 px-2 mb-8 lg:mb-0 text-xl lg:text-2xl lg:text-left">
                      100% female black-owned company providing full-service, lifestyle-based, professional event planning and project management.                
                    </p>
                  </div>
              </div>
              <img className="lg:ml-4 lg:w-1/2 lg:rounded-3xl" src={image} alt="Ubomi lunch"/>
            </div>
          </div>
        </div>
    </header>
